obj/machinery/atmospherics/trinary/mixer
	...
	process()
		...
		if((air1_moles < transfer_moles1) || (air2_moles < transfer_moles2))
			...
			var/ratio = min((transfer_moles1 ? air1_moles/transfer_moles1 : 1e31), (transfer_moles2 ? air2_moles/transfer_moles2 : 1e31))
...
/*	attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
	...
	attack_hand(user as mob)
		...
		if (!air2_moles)
			air2_moles = 1
		var/airO_moles = air3.total_moles()
		if (!airO_moles)
			airO_moles = 1

		var/Air1_Gas = "[round(100*air1.oxygen/air1_moles)] %O2 [round(100*air1.carbon_dioxide/air1_moles)] %CO2 [round(100*air1.nitrogen/air1_moles)] %N2 [round(100*air1.toxins/air1_moles)] %PL"
		var/Air2_Gas = "[round(100*air2.oxygen/air2_moles)] %O2 [round(100*air2.carbon_dioxide/air2_moles)] %CO2 [round(100*air2.nitrogen/air2_moles)] %N2 [round(100*air2.toxins/air2_moles)] %PL"
		var/AirO_Gas = "[round(100*air3.oxygen/airO_moles)] %O2 [round(100*air3.carbon_dioxide/airO_moles)] %CO2 [round(100*air3.nitrogen/airO_moles)] %N2 [round(100*air3.toxins/airO_moles)] %PL"
		...
		var/dat = {"<b>Power: </b><a href='?src=\ref[src];power=1'>[on?"On":"Off"]</a><br>
					...
					<br />
    				<b>Input Gas:</b><br />
    				<b>A:</b> [air1.return_pressure()]kPa [round(air1.temperature, 0.1)]K<br />
    				[Air1_Gas]<br />
    				<b>B:</b> [air2.return_pressure()]kPa [round(air2.temperature, 0.1)]K<br />
    				[Air2_Gas]<br />
    				<br />
    				<b>Output Gas:</b><br />
    				[air3.return_pressure()]kPa [round(air3.temperature, 0.1)]K<br />
    				[AirO_Gas]
					"}
