...
/obj/machinery/autolathe/New()
	...
	src.L += new /obj/item/weapon/surgical/scalpel(src)
	src.L += new /obj/item/weapon/surgical/circular_saw(src)
	...
	src.LL += new /obj/item/ammo_magazine/a357(src)
	src.LL += new /obj/item/ammo_magazine/c38(src)
