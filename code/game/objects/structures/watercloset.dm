...
/obj/machinery/shower/proc/update_icon()	//this is terribly unreadable, but basically it makes the shower mist up
...
/obj/machinery/shower/process()
	...
	if(isturf(loc))
		var/turf/tile = loc
		for(var/obj/effect/decal/cleanable/C in tile)
			del(C)
