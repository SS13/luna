...
/obj/structure/windoor_assembly/attackby(obj/item/W as obj, mob/user as mob)
	...
	switch(state)
		if("01")
			...
			//Adding r_metal makes the assembly a secure windoor assembly. Step 2 (optional) complete.
			else if(istype(W, /obj/item/stack/sheet/plasteel) && !secure)
				var/obj/item/stack/sheet/plasteel/P = W
				if(P.amount < 2)
					user << "\red You need more r_metal to do this."
					return
				user << "\blue You start to reinforce the windoor with r_metal."
