...
/obj/item/toy/crayon/rainbow/explosive
	uses = 20

/obj/item/toy/crayon/rainbow/explosive/afterattack(atom/target, mob/user as mob)
	if(istype(target,/turf/simulated/floor))
		...
		if(instant || do_after(user, 80))
			new /obj/effect/decal/cleanable/crayon/explosive(target,colour,shadeColour,drawtype)
