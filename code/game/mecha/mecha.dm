			...
			if(equipment.len)
				...
				if(destr)
					...
					while(null in equipment)
						equipment -= null
					destr.destroy()
					src.occupant_message("<font colour='red'>The [destr] is destroyed!</font>")
...
/obj/mecha/proc/get_stats_html()
	var/output = {"<html>
						...
						<style>
						body {colour: #00ff00; background: #000000; font: 13px 'Courier', monospace;}
...
/obj/mecha/proc/get_stats_part()
	...
	var/output = {"[internal_damage&MECHA_INT_FIRE?"<font colour='red'><b>INTERNAL FIRE</b></font><br>":null]
						[internal_damage&MECHA_INT_TEMP_CONTROL?"<font colour='red'><b>LIFE SUPPORT SYSTEM MALFUNCTION</b></font><br>":null]
						[internal_damage&MECHA_INT_TANK_BREACH?"<font colour='red'><b>GAS TANK BREACH</b></font><br>":null]
						[internal_damage&MECHA_INT_CONTROL_LOST?"<font colour='red'><b>COORDINATION SYSTEM CALIBRATION FAILURE</b></font> - <a href='?src=\ref[src];repair_int_control_lost=1'>Recalibrate</a><br>":null]
	...
	process(var/obj/mecha/mecha)
		...
		if(mecha.internal_damage & MECHA_INT_FIRE)
			...
			if(!(mecha.internal_damage & MECHA_INT_TEMP_CONTROL) && prob(5))
				...
				mecha.occupant_message("<font colour='blue'><b>Internal fire extinquished.</b></font>")
