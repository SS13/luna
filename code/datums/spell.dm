...
/obj/effect/proc_holder/mtrigger
	var/ProcRef
	...
	proc/trigger()
		...
		switch(arguments.len)
			if(1)
				call(ProcRef)(arguments[1])
			if(2)
				call(ProcRef)(arguments[1], arguments[2])
			if(3)
				call(ProcRef)(arguments[1], arguments[2], arguments[3])
			if(4)
				call(ProcRef)(arguments[1], arguments[2], arguments[3], arguments[4])
			if(5)
				call(ProcRef)(arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])