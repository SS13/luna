...
/obj/effect/landmark/random_asteroid		//Strumpetplaya - added for totally random asteroids.  Place this landmark down wherever you want to generate a random asteroid.
...
/turf/simulated/wall/asteroid
	...
	New()
		var/obj/effect/landmark/mining/newlandmark = new(src)
	...
	proc/destroy_asteroid(var/plasmacutter = 1)
		...
		W.dir = old_dir
		W.opacity = 1
		//W.sd_opacity = 0	Strumpetplaya - Commented out as it is currently unsupported
		W.levelupdate()
		return W
