...
/datum/surgery_step/incise
	implements = list(/obj/item/weapon/surgical/scalpel = 100, /obj/item/weapon/kitchen/utensil/knife = 85, /obj/item/weapon/shard = 65)
	time = 24
...
/datum/surgery_step/clamp_bleeders
	implements = list(/obj/item/weapon/surgical/hemostat = 100, /obj/item/weapon/wirecutters = 70, /obj/item/weapon/cable_coil = 15)
	time = 48
...
/datum/surgery_step/clamp_bleeders/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(surgery.current_organ && surgery.current_organ.wounds)
		for(var/datum/organ/external/wound/W in surgery.current_organ.wounds)
			W.stopbleeding()
	return ..()

//retract skin
/datum/surgery_step/retract_skin
	implements = list(/obj/item/weapon/surgical/retractor = 100, /obj/item/weapon/screwdriver = 65, /obj/item/weapon/wirecutters = 35)
	time = 32
...
/datum/surgery_step/close
	implements = list(/obj/item/weapon/surgical/cautery = 100, /obj/item/weapon/weldingtool = 70, /obj/item/weapon/lighter = 45, /obj/item/weapon/match = 20)
	time = 32
...
/datum/surgery_step/close/tool_check(mob/user, obj/item/tool)
	if(istype(tool, /obj/item/weapon/surgical/cautery))
		return 1
...
/datum/surgery_step/saw
	implements = list(/obj/item/weapon/surgical/circular_saw = 100, /obj/item/weapon/hatchet = 55/*, /obj/item/weapon/butch = 25*/)
	time = 64
