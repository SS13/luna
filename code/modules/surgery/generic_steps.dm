...
/datum/surgery_step/incise
	implements = list(/obj/item/weapon/scalpel = 100, /obj/item/weapon/kitchen/utensil/knife = 65, /obj/item/weapon/shard = 45)
	time = 24
...
/datum/surgery_step/clamp_bleeders
	implements = list(/obj/item/weapon/surgical/hemostat = 100, /obj/item/weapon/wirecutters = 60, /obj/item/weapon/cable_coil = 15)
	time = 48
...
/datum/surgery_step/retract_skin
	implements = list(/obj/item/weapon/surgical/retractor = 100, /obj/item/weapon/screwdriver = 45, /obj/item/weapon/wirecutters = 35)
	time = 32
