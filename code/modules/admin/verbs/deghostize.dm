...
/mob/dead/observer/proc/Deghostize(var/rank = "Unassigned")
	...
	switch(rank)
		if ("Counselor")
			...
			new_character.equip_if_possible(new /obj/item/clothing/under/rank/counselor(new_character), new_character.slot_w_uniform)
		...
		if ("Clown")
			...
			new_character.equip_if_possible(new /obj/item/clothing/under/clown(new_character), new_character.slot_w_uniform)
			...
			new_character.equip_if_possible(new /obj/item/weapon/banana(new_character), new_character.slot_in_backpack)
		...
		if ("Mime")
			...
			new_character.equip_if_possible(new /obj/item/clothing/under/mime(new_character), new_character.slot_w_uniform)
			new_character.equip_if_possible(new /obj/item/clothing/shoes/black(new_character), new_character.slot_shoes)
		...
		if ("Forensic Technician")
			...
			new_character.equip_if_possible(new /obj/item/clothing/under/ftech(new_character), new_character.slot_w_uniform)
		...
		if ("Barman")
			new_character.equip_if_possible(new /obj/item/clothing/under/bartender(new_character), new_character.slot_w_uniform)
		...
		if ("Chef")
			new_character.equip_if_possible(new /obj/item/clothing/under/chef(new_character), new_character.slot_w_uniform)
		...
		if ("Hydroponicist")
			...
			new_character.equip_if_possible(new /obj/item/device/radio/headset(new_character),new_character.slot_ears)
			new_character.equip_if_possible(new /obj/item/weapon/storage/backpack(new_character), new_character.slot_back)
			new_character.equip_if_possible(new /obj/item/clothing/head/green_band(new_character), new_character.slot_head)
			new_character.equip_if_possible(new /obj/item/clothing/suit/storage/apron(new_character), new_character.slot_wear_suit)

		if ("Quartermaster")
			new_character.equip_if_possible(new /obj/item/clothing/gloves/black(new_character), new_character.slot_gloves)
			new_character.equip_if_possible(new /obj/item/clothing/shoes/black(new_character), new_character.slot_shoes)
			new_character.equip_if_possible(new /obj/item/clothing/under/rank/qm(new_character), new_character.slot_w_uniform)
