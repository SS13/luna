...
/obj/machinery/chem_dispenser
	...
	"sodium","aluminium","silicon","phosphorus","sulfur","chlorine","potassium","iron","copper","mercury","radium","water","ethanol","sugar","sacid")
...
/obj/machinery/computer/pandemic/Topic(href, href_list)
	...
	if (href_list["create_vaccine"])
		...
		var/new_name = stripped_input(usr, "Name the Disease", "New Name", "", 26)
		if(..())
			return
...
/obj/machinery/reagentgrinder/proc/update_icon()
