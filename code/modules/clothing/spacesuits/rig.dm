...
/obj/item/clothing/head/helmet/space/rig
	...
	item_state = "eng_helm"
	armor = list(melee = 10, bullet = 15, laser = 10,energy = 10, bomb = 10, bio = 100, rad = 75)
...
/obj/item/clothing/suit/space/rig/mining
	...
	armor = list(melee = 40, bullet = 5, laser = 10,energy = 5, bomb = 50, bio = 100, rad = 50)
	allowed = list(/obj/item/device/flashlight,/obj/item/weapon/tank,/obj/item/weapon/satchel,/obj/item/weapon/pickaxe)
