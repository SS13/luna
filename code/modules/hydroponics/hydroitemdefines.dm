...
/obj/item/weapon/weedspray // -- Skie
	...
	item_state = "spray"
	flags = TABLEPASS | OPENCONTAINER | FPRINT | USEDELAY | ONBELT
	throwforce = 4
	w_class = 2.0
	throw_speed = 2
	throw_range = 10
...
// *************************************
// plantbgone defines for hydroponics
// *************************************

/obj/item/plantbgone
	name = "bottle of plantbgone"
	icon = 'icons/obj/chemical.dmi'
	icon_state = "bottle16"
	flags = FPRINT |  TABLEPASS
	var/toxicity = 0
...
/obj/item/plantbgone/glyphosate
