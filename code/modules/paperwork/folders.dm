...
/obj/item/weapon/folder/proc/update_icon()
	overlays.Cut()
	if(contents.len)
...
/obj/item/weapon/folder/attackby(obj/item/weapon/W, mob/user)
	if(istype(W, /obj/item/weapon/paper) || istype(W, /obj/item/weapon/photo))
		...
		var/n_name = copytext(sanitize(input(usr, "What would you like to label the folder?", "Folder Labelling", null)  as text), 1, 20)
